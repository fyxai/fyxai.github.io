        ...
        <div className="flex flex-wrap gap-2">
          {links.map(({ href, label, icon: Icon }) => (
            <Link
              key={href}
              href={href}
              className="inline-flex items-center gap-2 rounded-lg border border-cyan-400/20 px-3 py-2 text-sm text-slate-200 hover:border-cyan-300 hover:text-cyan-300"
            >
              <Icon size={16} />
              {label}
            </Link>
